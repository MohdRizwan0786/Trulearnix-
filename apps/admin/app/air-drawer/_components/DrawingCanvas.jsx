...
import { DrawingEngine } from '../_modules/drawingEngine';
import { StrokeManager } from '../_modules/strokeManager';
import { InteractionEngine } from '../_modules/interactionEngine';
import { TransformEngine } from '../_modules/transformEngine';
    ...
    switch (gesture) {
      case 'DRAW':
        if (!currentPathRef.current) {
          ...
          // Higher weight on previous point smooths out hand jitter; combined with
          // quadratic Bezier rendering this gives clean circles and readable writing.
